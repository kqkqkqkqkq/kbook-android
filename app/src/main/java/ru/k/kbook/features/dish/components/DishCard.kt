    ...
    Card(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                Text(dish.name, style = MaterialTheme.typography.titleMedium, maxLines = 1, overflow = TextOverflow.Ellipsis)
                Text("${dish.caloricity} kcal/порция", style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
            ...
            IconButton(onClick = { onDelete(dish) }, shape = MaterialTheme.shapes.small) { Icon(Icons.Filled.Delete, contentDescription = null) }
        }
    }
}
